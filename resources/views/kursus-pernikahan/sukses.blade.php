...
<section class="py-12 md:py-16 bg-gradient-to-br from-primary-800 via-primary-700 to-primary-600 text-white">
    <div class="max-w-2xl mx-auto px-4 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a href="{{ route('home') }}" class="btn-hover-lift border-2 border-white/50 text-white px-6 py-3 rounded-xl font-semibold text-sm hover:bg-white/10 transition-all inline-flex items-center justify-center gap-2 anim-scale-in anim-delay-11">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                Beranda
            </a>
        </div>
