...
<div class="filter-bar">
    <form method="GET" action="https://admin.biaraloresa.my.id/pendaftaran"
        ...
        @if(request('search') || request('status'))
            <a href="https://admin.biaraloresa.my.id/pendaftaran" style="padding:9px 14px;background:#f1f5f9;color:#64748b;border-radius:10px;font-size:13.5px;font-weight:500;text-decoration:none">
                Reset
            </a>
        @endif
    </form>
