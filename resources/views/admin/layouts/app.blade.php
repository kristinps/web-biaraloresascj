...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="https://admin.biaraloresa.my.id/dashboard"
        ...
        <a href="https://admin.biaraloresa.my.id/pendaftaran"
           class="nav-item {{ request()->is('pendaftaran*') ? 'active' : '' }}">
            <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <a href="https://admin.biaraloresa.my.id/users"
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            ...
            <form method="POST" action="https://admin.biaraloresa.my.id/logout">
                @csrf
