...
<style>
    ...
    .form-card-head { padding:18px 24px; background:linear-gradient(135deg,#0ea5e9,#0284c7); display:flex; align-items:center; gap:10px; }
    ...
    .user-banner { display:flex; align-items:center; gap:14px; padding:18px 24px; background:#f8fafc; border-bottom:1px solid #f1f5f9; }
    .user-banner .av { width:48px; height:48px; border-radius:12px; background:linear-gradient(135deg,#1e2685,#2b3fe8); display:flex; align-items:center; justify-content:center; font-size:20px; font-weight:700; color:#fff; flex-shrink:0; }
    .user-banner .nm { font-weight:700; color:#1e293b; font-size:15px; }
    .user-banner .em { font-size:13px; color:#94a3b8; margin-top:2px; }
    .user-banner .jn { font-size:12px; color:#94a3b8; margin-top:1px; }
    ...
    label .opt { color:#94a3b8; font-weight:400; font-size:12px; margin-left:4px; }
    ...
    .role-option label { display:flex; align-items:center; gap:10px; padding:12px 16px; border:1.5px solid #e2e8f0; border-radius:10px; cursor:pointer; transition:border-color .2s,background .2s; font-weight:500; font-size:13.5px; color:#475569; }
    .role-option input:checked + label { border-color:#1e2685; background:#eff6ff; color:#1e2685; }
    ...
    .divider-section { height:1px; background:#f1f5f9; margin:4px 0 20px; }
    .section-label { font-size:12px; font-weight:700; text-transform:uppercase; letter-spacing:.6px; color:#94a3b8; margin-bottom:14px; }
    ...
    .btn-cancel { display:inline-flex; align-items:center; gap:6px; padding:10px 18px; background:#f1f5f9; color:#475569; border:none; border-radius:10px; font-size:14px; font-weight:600; text-decoration:none; transition:background .15s; }
...
<div class="form-card">
    ...
    <div class="user-banner">
        ...
        <div>
            ...
            <div class="jn">Bergabung {{ $user->created_at->format('d M Y') }}</div>
        </div>
    </div>

    <form method="POST" action="https://admin.biaraloresa.my.id/users/{{ $user->id }}">
        @csrf
        @method('PUT')
        ...
        <div class="form-body">
            ...
            <div class="section-label">Ubah Kata Sandi <span style="font-weight:400;font-size:11px;color:#94a3b8;text-transform:none;letter-spacing:0">(Kosongkan jika tidak ingin mengubah)</span></div>

            <div class="form-row">
                <div class="form-group">
                    <label for="password">Kata Sandi Baru <span class="opt">(opsional)</span></label>
                    <div class="input-wrap">
                        <svg class="input-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="password" id="password_confirmation" name="password_confirmation"
                               placeholder="Ulangi kata sandi baru" class="has-eye">
        ...
        <div class="form-footer">
            <a href="https://admin.biaraloresa.my.id/users" class="btn-cancel">Batal</a>
