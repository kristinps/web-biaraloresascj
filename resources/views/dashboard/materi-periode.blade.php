...
@section('page-subtitle', 'Pilih periode untuk mengelola materi kursus pernikahan')
...
<style>
    ...
    .periode-icon.aktif { background: linear-gradient(135deg,#6366f1,#8b5cf6); box-shadow: 0 4px 12px rgba(99,102,241,0.3); }
    ...
    .btn-materi { display: inline-flex; align-items: center; gap: 6px; padding: 8px 16px; background: linear-gradient(135deg,#6366f1,#8b5cf6); color: #fff; border-radius: 10px; font-size: 13px; font-weight: 600; text-decoration: none; transition: opacity 0.2s; }
    .btn-materi:hover { opacity: 0.9; color: #fff; }
    .btn-materi svg { width: 16px; height: 16px; }
...
<div class="card">
    @if($periodeAktif->count() > 0)
        ...
        <div class="periode-item">
            ...
            <a href="{{ route('dashboard.materi.index', $p) }}" class="btn-materi">
                <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                Kelola Materi
            </a>
        </div>
...
<div class="card">
    @if($periodeSelesai->count() > 0)
        ...
        <div class="periode-item">
            ...
            <a href="{{ route('dashboard.materi.index', $p) }}" class="btn-materi">Kelola Materi</a>
        </div>
        @endforeach
    @else
