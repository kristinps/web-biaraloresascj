        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    @endauth
                    <a href="{{ route('kontak') }}" class="border-2 border-primary-700 text-primary-700 text-sm px-4 py-2 rounded-lg hover:bg-primary-50 transition-colors font-medium">Kontak</a>
                </div>
